   ...
   <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **New: At-a-glance Insights are now available in the Sidebar**
        ...
        ![image](../images/sidebar-counts.gif)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        **Enhanced Visibility with Status Updates During File Extraction**
        ...
        ![image](../images/extract-status.gif)
...
<div style={{ display: "table-row", width: "auto" }}>
     ...
     **Field Descriptions now have Markdown Support**
     ...
     ![image](../images/tooltips-with-markdown.gif)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
     ...
     **Enhanced Theming Interactive options**
     ...
     ![image](../images/theming_dropdowns.png)
...
<div style={{ display: "table", width: "auto" }}>
     ...
     **Enhanced Theming options for Checkboxes**
     ...
     ![image](../images/theming_checkboxes.png)
...
<div style={{ display: "table", width: "auto" }}>
     ...
     **Enhanced Theming options for Badges+**
     ...
     ![image](../images/theming_badges.png)
...
<div style={{ display: "table", width: "auto" }}>
  <div style={{ display: "table-row", width: "auto" }}>
     ...
     **Revamped UI for Foreground Jobs**
     ...
     ![image](../images/foreground_facelift.png)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
     ...
     **Enhanced Theming options for Filters**
     ...
     ![image](../images/theming_chips.png)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **Space ID Search is now available in the Spaces Table**
        ...
        ![image](../images/search_spaces.gif)
...
<div style={{ display: "table", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        ![image](../images/bulk_delete_sm.gif)
   ...
   <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **New: Column Visibility Control with Local Storage Memory**
         ...
         ![image](../images/column_hiding.gif)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **Full Whitelabeling now available in Pro+**
        ...
        ![image](../images/whitelabeling.png)
 ...
 <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **Actions are now available on Documents.**
        ...
        ![image](../images/document_actions_primary.png)
...
<div style={{ display: "table-row", width: "auto" }}>
       ...
       **Now Available: Set estimated time of completion on Jobs**
        ...
        ![image](../images/estimatedTime_actions.png)
...
<div style={{ display: "table", width: "auto" }}>
 ...
 <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        ![image](../images/action_inputs.png)
    ...
    <div style={{ display: "table-row", width: "auto" }}>
      ...
      >
        ...
        **New: Promote Sheet Actions**
        ...
        ![image](../images/primary_actions.png)
...
<div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **Introducing: Code Blocks for Documents**
      ...
      ![image](../images/documents_codeblocks.png)
      ...
      ![image](../images/documents_codeblocks_sample.png)
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      **`acknowledge: false`**
      ...
      ![image](../images/outcome_modal.png)
      ...
      **`acknowledge: true`**
      ...
      ![image](../images/outcome_fullscreen.png)
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  <div style={{ display: "table-row", width: "auto" }}>
    ...
    >
      ...
      ![image](../images/tooltips-actions.png)
...
<div style={{ display: "table-row", width: "auto" }}>
  ...
  >
    ...
    <div style={{ display: "table-row", width: "auto" }}>
      ...
      ![image](../images/sidebar_collapsed.png)
